...
class Ui_WatchCardsWindow(object):
    ...
    def setupUi(self, MainWindow, current_card_ind = 0):
        ...
        name = reg.registered_sellers[mainwindow.current_seller_account_ind].product_cards_list[self.current_card_ind].name
        cost = reg.registered_sellers[mainwindow.current_seller_account_ind].product_cards_list[self.current_card_ind].cost
        rate = reg.registered_sellers[mainwindow.current_seller_account_ind].product_cards_list[self.current_card_ind].average_rating
        descr = reg.registered_sellers[mainwindow.current_seller_account_ind].product_cards_list[self.current_card_ind].description
