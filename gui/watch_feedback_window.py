...
class Ui_WatchFeedbackWindow(object):
    def setupUi(self, MainWindow, current_seller, current_card):
        ...
        self.label__rate.setGeometry(QtCore.QRect(10, 160, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label__rate.setFont(font)
        self.label__rate.setObjectName("label_2")
        ...
        self.label__info = QtWidgets.QLabel(self.centralwidget)
        self.label__info.setGeometry(QtCore.QRect(20, 220, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label__info.setFont(font)
        self.label__info.setObjectName("label_3")
        self.label__NAME = QtWidgets.QLabel(self.centralwidget)
        self.label__NAME.setGeometry(QtCore.QRect(10, 80, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label__NAME.setFont(font)
        self.label__NAME.setObjectName("label_4")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label__info.setText(_translate("MainWindow", "Подробности:"))
